...
public class SavedRepresentativeListActivity extends AppCompatActivity implements OnStartDragListener {
    ...
    private void setUpFirebaseAdapter() {
        ...
        mFirebaseAdapter = new FirebaseRepresentativeListAdapter(Representative.class, R.layout.representative_list_item_drag, FirebaseRepresentativeViewHolder.class, mRepresentativeReference, this, this);
